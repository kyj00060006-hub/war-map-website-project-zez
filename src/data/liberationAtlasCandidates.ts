...
export const liberationAtlasReviewRoot = "professional_review_package_v2_prefilled/06_图册页归属审查";
...
export const liberationAtlasCandidateSummary = {
  ...
  "medium": 13,
  "mapLike": 19,
  "reviewTablePath": "professional_review_package_v2_prefilled/06_图册页归属审查/图册页归属专家判定表.csv",
